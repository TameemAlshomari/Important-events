...
insert into event ( title, note, location, updated_at) values ('book', 'reading', 'Budapest1',  '12-06-2017');
insert into event ( title, note, location, updated_at) values ('film', 'watching', 'Budapest2',  '12-15-2017');
insert into event ( title, note, location, updated_at) values ('cinema', 'watching', 'Budapest3',  '12-25-2017');
insert into event ( title, note, location, updated_at) values ('workshop', 'listenning', 'Budapest4',  '01-01-2018');
insert into event ( title, note, location, updated_at) values ('standup comedy', 'speaking', 'Budapest5',  '05-01-2018');
insert into event ( title, note, location, updated_at) values ('speaking', 'speaking', 'Budapest6',  '10-01-2018');
